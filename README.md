...
The goal of this website is to provide a brief, personal approach to making your way into the world of code and becoming a Software Developer.  I believe strongly that we are all individuals and whichever course you go for has to fit all of your needs to give you the best chance of succeeding.  I have biased my findings in favour of the Full Stack Developer Course at The Code Institute and The Learning People.  I have intended for the information given to be geared towards being holistic as well as providing links to The Code Institute course and a contact form for any suggestions.  I wanted to give someone new to Coding an idea of what to expect and give them the basic tools, physical or otherwise, to get started.
***
...
2. The user can expect the header and menu to stay in the same position on every page so the title of the site is visible and the menu is always displayed at the top of the page making navigation easy and consistent for the user.
...
I was advised by my mentor to put a personalised error page so I used the same image for the Contact page and added a slightly humorous message including a link to the Home page.
...
1. Text not allowed in element “iframe” in this context. From line 92, column 172 to line 92, column 175
        Code Extract:
        rogramme"Code↩
2. Text not allowed in element “iframe” in this context. From line 93, column 1 to line 93, column 66
        Code Extract:
...
4. Text not allowed in element “iframe” in this context. From line 99, column 154 to line 99, column 157
        Code Extract:
        with it"What↩
5. Text not allowed in element “iframe” in this context. From line 100, column 1 to line 100, column 45
        Code Extract:
        it">What is Imposter Syndrome?</ifr

##### On contact.html; 1 error found

1. The “for” attribute of the “label” element must refer to a non-hidden form control. From line 85, column 21 to line 85, column 52
        Code Extract:
...
And the result for my css was this:

![Screenshot 2022-02-28 at 20 00 53](https://user-images.githubusercontent.com/96961963/156050465-9ce609ca-219e-41f2-a3e2-976b0259d46c.png)

At an early attempt with the W3C CSS Validator it found 1 error in CSS on line 161 showing opacity: 1s, which you will see I corrected in the Bugs section.
...
1. [Balsamiq](https://balsamiq.com/)
    - I used Balsamiq to create a very rough outline of the site and I added extensive paragraph content here too.
